/****************************************************************************
 * boards/arm/stm32h7/nucleo-h750vb/src/stm32_usb.c
 *
...
#ifndef CONFIG_NUCLEOH750VB_USBHOST_PRIO
#  define CONFIG_NUCLEOH750VB_USBHOST_PRIO 100
#endif

#ifndef CONFIG_NUCLEOH750VB_USBHOST_STACKSIZE
#  define CONFIG_NUCLEOH750VB_USBHOST_STACKSIZE 1024
#endif
  ...
  if (g_usbconn)
    {
      ...
      pid = kthread_create("usbhost", CONFIG_NUCLEOH750VB_USBHOST_PRIO,
                           CONFIG_NUCLEOH750VB_USBHOST_STACKSIZE,
